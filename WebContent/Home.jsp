...
<%=message %><%} %>
		...
		<div>
			<div class="aside">
				<div class="aside-div">
					<a href="AddBook.jsp" target="iframe_c">Add Book</a>
				</div>
				<div class="aside-div">
					<a href="DeleteBook.jsp" target="iframe_c">Delete Book</a>
				</div>
				<div class="aside-div">
				...
				<div class="aside-div">
					<a href="UpdateUser.jsp" target="iframe_c">update User</a>
				</div>
				<div class="aside-div">
			...
			--><div class="iframe">
				<iframe height="450px" width="100%" name="iframe_c"><div><img src=></div></iframe>
			</div>
		</div>
	</body>
	</html>